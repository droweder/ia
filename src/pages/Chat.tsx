  ...
  return (
    <div className="flex flex-1 flex-col h-full bg-transparent overflow-hidden transition-colors duration-200">
      ...
      <div className="flex-1 flex flex-col min-w-0 bg-transparent transition-colors duration-200">
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 md:p-6 space-y-6 bg-transparent scrollbar-thin scrollbar-thumb-blue-500 dark:scrollbar-thumb-blue-500/50 hover:scrollbar-thumb-blue-600 dark:hover:scrollbar-thumb-blue-400/80">
