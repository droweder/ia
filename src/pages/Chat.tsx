...
let systemPrompt = `Você é o DRoweder IA, um assistente especialista em manufatura conectado ao ERP Planintex.
  ...
  return (
    <div className="flex flex-1 flex-col h-full min-h-0 bg-transparent overflow-hidden transition-colors duration-200">
      ...
      {/* Main Chat Area */}
      <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-transparent transition-colors duration-200 relative">
        ...
        <div className="absolute top-4 left-4 z-50" ref={modelMenuRef}>
            <div className="relative">
                ...
                {/* Dropdown de Modelos */}
                {showModelMenu && (
                    <div className="absolute top-full left-0 mt-2 w-64 bg-white/90 dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-xl shadow-xl overflow-hidden z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                                ...
                                <button
                                    ...
                                    className={`w-full flex flex-col text-left px-3 py-2 rounded-lg transition-colors ${
                                        selectedModelId === modelOption.id
                                            ...
                                            : 'hover:bg-slate-50 dark:hover:bg-white/10 border border-transparent'
                                    }`}
                                >
            ...
            <div className="max-w-3xl mx-auto relative">
                <div className="relative flex flex-col group bg-[#f4f4f4] dark:bg-[#2f2f2f] rounded-[26px] transition-all overflow-hidden focus-within:ring-2 focus-within:ring-gray-300 dark:focus-within:ring-gray-600">
                    ...
                    <div className="relative flex items-end">
                        <div className="flex items-center justify-center p-2 pl-3 pb-[10px] gap-1">
                            <button
