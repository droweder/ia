...
export default function Assistants() {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 min-h-0 bg-transparent transition-colors duration-200">
      {/* Header */}
      <div className="h-14 border-b border-slate-200 dark:border-white/10 flex justify-between items-center bg-black/5 dark:bg-white/5 backdrop-blur-md px-6 shadow-sm z-10 shrink-0">
      ...
      <div className="px-6 pt-6 pb-2 shrink-0">
         <div className="relative max-w-xl mx-auto">
              ...
              <input
                  ...
                  className="w-full bg-black/5 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-xl py-3 pl-11 pr-4 text-slate-800 dark:text-white placeholder-slate-400 dark:placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-colors"
              />
         </div>
      </div>
            ...
            {results.length === 0 ? (
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                   {results.map((assistant) => (
                      <div
                          key={assistant.id}
                          className="flex flex-col p-5 rounded-xl border border-slate-200 dark:border-white/10 bg-black/5 dark:bg-white/5 hover:border-blue-500/50 hover:shadow-md transition-all group"
                      >
