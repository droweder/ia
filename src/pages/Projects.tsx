          ...
          <div className="flex-shrink-0 flex items-center justify-between p-6 border-b border-slate-200 dark:border-white/5">
            <div className="flex items-center gap-4">
              <button
                ...
                className="p-2 -ml-2 rounded-lg text-slate-500 hover:text-slate-800 dark:text-slate-500 dark:text-gray-400 dark:hover:text-white hover:bg-black/10 dark:bg-white/10 transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                {projectConversations.map(chat => (
                  <div
                    ...
                    className="group flex flex-col p-4 rounded-xl bg-black/5 dark:bg-white/5 border border-slate-200 dark:border-white/10 hover:border-blue-500/50 cursor-pointer transition-all shadow-sm hover:shadow-md"
                  >
      ...
      <div className="flex-1 overflow-y-auto p-6 scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-blue-800 hover:scrollbar-thumb-slate-400 dark:hover:scrollbar-thumb-blue-700">
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            <button
              onClick={() => setIsCreateOpen(true)}
              className="group flex flex-col items-center justify-center min-h-[160px] rounded-2xl border-2 border-dashed border-slate-200 dark:border-white/20 bg-transparent hover:bg-black/5 dark:bg-white/5 transition-colors"
            >
              <div className="w-10 h-10 rounded-full bg-slate-100 dark:bg-black/5 dark:bg-white/5 flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
            ...
            {projects.map((project) => (
              <div
                ...
                className="group relative flex flex-col p-5 cursor-pointer min-h-[160px] rounded-2xl bg-black/5 dark:bg-white/5 backdrop-blur-md border border-slate-200 dark:border-white/10 hover:border-blue-500/50 transition-all shadow-sm hover:shadow-md overflow-hidden"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-slate-700 dark:hover:text-white hover:bg-black/10 dark:bg-white/10 rounded-lg transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
                  >
                ...
                {openMenuId === project.id && createPortal(
                  <div
                    ...
                    className="w-48 bg-black/5 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-xl shadow-xl py-2 animate-in fade-in slide-in-from-top-2 duration-200"
                  >
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2 text-sm text-slate-800 dark:text-gray-200 hover:bg-black/10 dark:bg-white/10 transition-colors"
                    >
                      <Pencil size={16} />
                      Renomear
                    </button>
                    <div className="h-px bg-slate-200 dark:bg-black/10 dark:bg-white/10 my-1 mx-4"></div>
                    <button
                      onClick={(e) => {
                        e.stopPropagation();
                        setOpenMenuId(null);
                      ...
                      className="w-full flex items-center gap-3 px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:bg-black/10 dark:bg-white/10 transition-colors"
                    >
                      <Trash2 size={16} />
                      Excluir
                    </button>
