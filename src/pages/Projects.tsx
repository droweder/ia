...
import { Folder, Plus, MoreVertical, Pencil, Trash2, Calendar, MessageSquare } from 'lucide-react';
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            ...
            {projects.map((project) => (
              <div
                key={project.id}
                className="group relative flex flex-col p-5 min-h-[160px] rounded-2xl bg-white/50 dark:bg-slate-800/50 backdrop-blur-md border border-slate-200 dark:border-white/10 hover:border-blue-500/50 dark:hover:border-blue-500/50 transition-all shadow-sm hover:shadow-md overflow-hidden"
              >
