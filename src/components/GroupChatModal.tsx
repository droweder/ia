        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white/40 dark:bg-black/20 border border-slate-200 dark:border-white/10 rounded-xl focus:ring-2 focus:ring-[#3b82f6] focus:border-transparent outline-none transition-all text-slate-900 dark:text-white placeholder-slate-400 dark:placeholder-gray-400 text-sm shadow-sm"
            />
          </div>
          ...
          <div className="flex justify-between items-center pt-4 border-t border-slate-100 dark:border-white/5">
            ...
            <div className="flex gap-3">
                ...
                className="flex items-center justify-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-xl transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                >
                Iniciar Grupo
                </button>
            </div>
