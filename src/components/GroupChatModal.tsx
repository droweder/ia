        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-all text-white placeholder-gray-500 text-sm"
            />
          </div>
          ...
          <div className="space-y-2 max-h-[240px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-slate-300 scrollbar-thumb-blue-800">
            {filteredUsers.length > 0 ? (
                ...
                <div
                    ...
                    className={`flex items-center justify-between p-3 rounded-xl cursor-pointer border transition-colors ${selectedUsers.includes(user.id) ? 'bg-emerald-900/20 border-emerald-800/50' : 'bg-transparent border-transparent hover:bg-white/5'}`}
                >
          ...
          <div className="flex justify-between items-center pt-4 border-t border-white/10">
            ...
            <div className="flex gap-3">
                ...
                type="button"
                onClick={onClose}
                className="px-4 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 rounded-xl transition-colors"
                >
                Cancelar
                </button>
                <button
                ...
                className="flex items-center justify-center px-4 py-2 bg-blue-500 hover:bg-blue-600 text-white text-sm font-medium rounded-xl transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
                Iniciar Grupo
                </button>
            </div>
