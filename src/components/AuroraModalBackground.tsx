...
export const AuroraModalBackground: React.FC = () => {
  return (
    <>
      ...
      <div className="absolute inset-0 bg-white dark:bg-[#0B0F19] z-[-2]" />

      {/* Animated Aurora Blobs - Scaled down for modal size */}
      <div className="absolute inset-0 overflow-hidden z-[-1] pointer-events-none opacity-40 dark:opacity-80">
      ...
      <div className="absolute inset-0 bg-white/50 dark:bg-black/20 z-[-1]" />
    </>
  );
};
