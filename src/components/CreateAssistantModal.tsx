        ...
        <div className="px-6 pb-6 flex flex-col gap-6">
          ...
          <div className="space-y-4">
            <div>
                ...
                <div className="relative group">
                    <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400 group-focus-within:text-slate-800 dark:group-focus-within:text-white transition-colors">
                    ...
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-3 pl-12 pr-4 text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm"
                    autoFocus
                    />
                </div>
            </div>
            ...
            <div>
                 ...
                 <input
                    ...
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2 px-4 text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm text-sm"
                 />
            </div>
            ...
            <div>
                 ...
                 <textarea
                    ...
                    rows={4}
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2 px-4 text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm text-sm resize-none scrollbar-thin"
                 />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 hover:bg-slate-50 dark:hover:bg-white/10 bg-white/5 backdrop-blur-sm transition-colors text-sm font-medium text-white shadow-sm">
