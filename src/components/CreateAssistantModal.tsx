      ...
      <div className="relative bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 text-slate-800 dark:text-gray-200 w-full max-w-[600px] rounded-2xl shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between p-6 pb-4">
          ...
          <div className="flex items-center gap-2">
            <button className="p-2 text-gray-400 hover:text-slate-800 dark:text-white transition-colors rounded-lg hover:bg-white/10">
              <Settings size={20} />
            </button>
        ...
        <div className="px-6 pb-6 flex flex-col gap-6">
          ...
          <div className="space-y-4">
            <div>
                ...
                <div className="relative group">
                    ...
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-3 pl-12 pr-4 text-slate-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm"
                    autoFocus
                    />
                </div>
            </div>
            ...
            <div>
                 ...
                 <input
                    ...
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2 px-4 text-slate-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm text-sm"
                 />
            </div>
            ...
            <div>
                 ...
                 <textarea
                    ...
                    rows={4}
                    className="w-full bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl py-2 px-4 text-slate-800 dark:text-white placeholder-gray-500 focus:outline-none focus:border-gray-400 transition-colors shadow-sm text-sm resize-none scrollbar-thin"
                 />
            </div>
          </div>
          ...
          <div className="flex flex-wrap gap-3">
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-xl border border-white/10 hover:bg-slate-50 dark:hover:bg-white/10 bg-white/5 backdrop-blur-sm transition-colors text-sm font-medium text-slate-800 dark:text-white shadow-sm">
        ...
        {/* Footer */}
        <div className="p-6 pt-2 flex justify-end border-t border-white/10 mt-2">
          <button
            onClick={handleCreate}
            disabled={!assistantName.trim()}
            className="px-6 py-2.5 mt-2 rounded-full bg-white text-black font-semibold text-sm disabled:opacity-50 disabled:bg-slate-200 disabled:dark:bg-gray-600 disabled:text-slate-500 disabled:dark:text-gray-400 transition-all hover:opacity-90 active:scale-95"
          >
