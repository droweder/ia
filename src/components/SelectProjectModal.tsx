...
export function SelectProjectModal({ isOpen, onClose, projects, onSelectProject }: SelectProjectModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="w-full max-w-md rounded-2xl bg-white/90 p-6 shadow-xl dark:bg-slate-800/90 backdrop-blur-xl border border-slate-200 dark:border-white/10">
