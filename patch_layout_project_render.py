...
replacement = """                        {projects.map((project) => (
                            <div key={project.id} className="relative group">
                               ...
                               <button
                                   ...
                                   className="absolute right-2 top-1 opacity-0 group-hover:opacity-100 p-1 hover:bg-slate-300 dark:hover:bg-white/20 rounded text-slate-500 dark:text-gray-400 hover:text-slate-900 dark:hover:text-white transition-all"
                               >
